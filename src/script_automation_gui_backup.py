...
class ScriptAutomationGUI(ctk.CTkFrame):
    ...
    def _create_editor_tab(self):
        ...
        container = tk.Frame(self.editor_tab, bg=self.colors['bg'])
        container.pack(fill=tk.BOTH, expand=True, padx=20, pady=20)

        # Toolbar
        toolbar = tk.Frame(container, bg=self.colors['secondary'])
        toolbar.pack(fill=tk.X, pady=(0, 10))

        # Nom du script
        name_frame = tk.Frame(toolbar, bg=self.colors['secondary'])
        ...
        self.script_name_entry = tk.Entry(
            name_frame,
            bg='#1a1a1a',
            fg=self.colors['fg'],
            font=('Segoe UI', 10),
        ...
        # Boutons
        btn_frame = tk.Frame(toolbar, bg=self.colors['secondary'])
        ...
        # Éditeur de code
        editor_frame = tk.Frame(container, bg=self.colors['bg'])
    ...
    def _create_templates_tab(self):
        """Onglet templates"""
        container = tk.Frame(self.templates_tab, bg=self.colors['bg'])
        container.pack(fill=tk.BOTH, expand=True, padx=20, pady=20)
        ...
        # Liste des templates
        templates_frame = tk.Frame(container, bg=self.colors['bg'])
    ...
    def _create_template_card(self, parent, template_id, name, description, language):
        ...
        card = tk.Frame(parent, bg=self.colors['secondary'], relief=tk.FLAT)
    ...
    def _create_scripts_tab(self):
        """Onglet mes scripts"""
        container = tk.Frame(self.scripts_tab, bg=self.colors['bg'])
        container.pack(fill=tk.BOTH, expand=True, padx=20, pady=20)
    ...
    def _create_scheduler_tab(self):
        ...
        container = tk.Frame(self.scheduler_tab, bg=self.colors['bg'])
        container.pack(fill=tk.BOTH, expand=True, padx=20, pady=20)
    ...
    def refresh_tasks_list(self):
        ...
        for task in tasks:
            state = "✅ Activée" if task['enabled'] else "⏸️ Désactivée"
